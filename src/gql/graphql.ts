...
export type Match = {
  ...
  state: MatchState;
  userEntryIndices?: Maybe<Array<Scalars['Int']['output']>>;
...
export type Mutation = {
  ...
  refillActionPoint: Scalars['TxId']['output'];
  refillActionPointByWallet: Scalars['TxId']['output'];
...
export type MutationCreateSessionArgs = {
  ...
  numberOfActiveGloves: Scalars['Int']['input'];
  numberOfInitialGloves: Scalars['Int']['input'];
  privateKey?: InputMaybe<Scalars['PrivateKey']['input']>;
...
export type MutationRefillActionPointArgs = {
  privateKey?: InputMaybe<Scalars['PrivateKey']['input']>;
};
...
export type Player = {
  ...
  gloveInactive?: Maybe<Array<Scalars['Boolean']['output']>>;
  gloveUsed?: Maybe<Array<Scalars['Boolean']['output']>>;
  healthPoint: Scalars['Int']['output'];
  initialGloves?: Maybe<Array<Scalars['Address']['output']>>;
...
export type Query_ActionQuery = {
  ...
  refillActionPoint?: Maybe<Scalars['Hex']['output']>;
...
export type Round = {
  ...
  roundRuleData?: Maybe<RoundRuleData>;
  winner: Scalars['Int']['output'];
};

export type RoundRuleData = {
  __typename?: 'RoundRuleData';
  parameters?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  type: RoundRuleType;
};

export enum RoundRuleType {
  Banglovetype = 'BANGLOVETYPE',
  Damageamplification = 'DAMAGEAMPLIFICATION',
  None = 'NONE'
}

export type RoundRuleValue = {
  __typename?: 'RoundRuleValue';
  appliedAt: Scalars['Int']['output'];
  parameters?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  type: RoundRuleType;
};
...
export type Session = {
  ...
  startHeight: Scalars['Long']['output'];
  state: SessionState;
  userEntries?: Maybe<Array<Maybe<UserEntry>>>;
};
...
export type SessionEventData = {
  ...
  myDisabledGloves?: Maybe<Array<Scalars['Boolean']['output']>>;
  myPlayer?: Maybe<Player>;
  opponentAddress?: Maybe<Scalars['Address']['output']>;
  opponentDisabledGloves?: Maybe<Array<Scalars['Boolean']['output']>>;
  opponentPlayer?: Maybe<Player>;
  organizerAddress?: Maybe<Scalars['Address']['output']>;
  playersLeft?: Maybe<Scalars['Int']['output']>;
  roundRules?: Maybe<Array<Maybe<RoundRuleValue>>>;
  sessionId?: Maybe<Scalars['Address']['output']>;
  sessionState: SessionState;
  userEntryState?: Maybe<UserEntryState>;
};
...
export type SessionMetadata = {
  ...
  numberOfActiveGloves: Scalars['Int']['output'];
  numberOfInitialGloves: Scalars['Int']['output'];
  organizer: Scalars['Address']['output'];
  prize?: Maybe<Scalars['Address']['output']>;
...
export type UserData = {
  ...
  id: Scalars['Address']['output'];
  lastClaimedAt: Scalars['Long']['output'];
...
export type GetUserQuery = { __typename?: 'Query', stateQuery?: { __typename?: 'Query_StateQuery', getUserData?: { __typename?: 'UserData', id: any, name?: string | null, registeredGloves?: Array<any> | null, equippedGlove: any, sessionId: any, balance: any, actionPoint: number, lastClaimedAt: any, ownedGloves?: Array<{ __typename?: 'GloveInfo', id: any, count: number } | null> | null } | null } | null };
...
export type GetSessionsQuery = { __typename?: 'Query', stateQuery?: { __typename?: 'Query_StateQuery', sessions?: Array<{ __typename?: 'Session', state: SessionState, creationHeight: any, startHeight: any, metadata?: { __typename?: 'SessionMetadata', id: any, organizer: any, prize?: any | null, maximumUser: number, minimumUser: number, remainingUser: number, users?: Array<any> | null } | null, userEntries?: Array<{ __typename?: 'UserEntry', id: any, initialGloves?: Array<any> | null } | null> | null } | null> | null } | null };
...
export type GetUserScopedSessionQuery = { __typename?: 'Query', stateQuery?: { __typename?: 'Query_StateQuery', userScopedSession?: { __typename?: 'SessionEventData', sessionId?: any | null, height: any, sessionState: SessionState, organizerAddress?: any | null, opponentAddress?: any | null, currentInterval: any, isPlayer: boolean, playersLeft?: number | null, currentPhaseIndex?: number | null, currentUserRoundIndex?: number | null, myDisabledGloves?: Array<boolean> | null, opponentDisabledGloves?: Array<boolean> | null, lastRoundWinner?: string | null, currentUserMatchState?: MatchState | null, userEntryState?: UserEntryState | null, intervalEndHeight: any, myPlayer?: { __typename?: 'Player', address: any, initialGloves?: Array<any> | null, gloveInactive?: Array<boolean> | null, gloveUsed?: Array<boolean> | null, healthPoint: number, submission: number, activeEffectData?: Array<{ __typename?: 'EffectData', type: EffectType, duration: number, parameters?: Array<number> | null } | null> | null } | null, opponentPlayer?: { __typename?: 'Player', address: any, initialGloves?: Array<any> | null, gloveInactive?: Array<boolean> | null, gloveUsed?: Array<boolean> | null, healthPoint: number, submission: number, activeEffectData?: Array<{ __typename?: 'EffectData', type: EffectType, duration: number, parameters?: Array<number> | null } | null> | null } | null, roundRules?: Array<{ __typename?: 'RoundRuleValue', type: RoundRuleType, parameters?: Array<string | null> | null, appliedAt: number } | null> | null } | null } | null };
...
export type GetSessionHeaderQuery = { __typename?: 'Query', stateQuery?: { __typename?: 'Query_StateQuery', session?: { __typename?: 'Session', state: SessionState, creationHeight: any, startHeight: any, metadata?: { __typename?: 'SessionMetadata', id: any, organizer: any, prize?: any | null, maximumUser: number, minimumUser: number, remainingUser: number, startAfter: any, maxRounds: number, roundLength: any, roundInterval: any, initialHealthPoint: number, numberOfInitialGloves: number, numberOfActiveGloves: number } | null, userEntries?: Array<{ __typename?: 'UserEntry', id: any, initialGloves?: Array<any> | null } | null> | null } | null } | null };
...
export type GetSessionQuery = { __typename?: 'Query', stateQuery?: { __typename?: 'Query_StateQuery', session?: { __typename?: 'Session', state: SessionState, creationHeight: any, startHeight: any, height: any, metadata?: { __typename?: 'SessionMetadata', id: any, organizer: any, prize?: any | null, maximumUser: number, minimumUser: number, remainingUser: number, startAfter: any, maxRounds: number, roundLength: any, roundInterval: any, initialHealthPoint: number, numberOfInitialGloves: number, numberOfActiveGloves: number, users?: Array<any> | null } | null, userEntries?: Array<{ __typename?: 'UserEntry', id: any, initialGloves?: Array<any> | null, state: UserEntryState } | null> | null, phases?: Array<{ __typename?: 'Phase', height: any, matches?: Array<{ __typename?: 'Match', startHeight: any, state: MatchState, winner: number, rounds?: Array<{ __typename?: 'Round', winner: number, player1?: { __typename?: 'Player', address: any, initialGloves?: Array<any> | null, gloveInactive?: Array<boolean> | null, gloveUsed?: Array<boolean> | null, healthPoint: number, submission: number, activeEffectData?: Array<{ __typename?: 'EffectData', type: EffectType, duration: number, parameters?: Array<number> | null } | null> | null } | null, player2?: { __typename?: 'Player', address: any, initialGloves?: Array<any> | null, gloveInactive?: Array<boolean> | null, gloveUsed?: Array<boolean> | null, healthPoint: number, submission: number, activeEffectData?: Array<{ __typename?: 'EffectData', type: EffectType, duration: number, parameters?: Array<number> | null } | null> | null } | null } | null> | null } | null> | null } | null> | null } | null } | null };
...
export type RefillActionPointActionQueryVariables = Exact<{ [key: string]: never; }>;


export type RefillActionPointActionQuery = { __typename?: 'Query', actionQuery?: { __typename?: 'Query_ActionQuery', refillActionPoint?: any | null } | null };
...
export const RefillActionPointActionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RefillActionPointAction"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"actionQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refillActionPoint"}}]}}]}}]} as unknown as DocumentNode<RefillActionPointActionQuery, RefillActionPointActionQueryVariables>;
...
export const RefillActionPointByWalletDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RefillActionPointByWallet"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"refillActionPointByWallet"}}]}}]} as unknown as DocumentNode<RefillActionPointByWalletMutation, RefillActionPointByWalletMutationVariables>;